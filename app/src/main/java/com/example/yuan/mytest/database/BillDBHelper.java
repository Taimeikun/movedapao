...
import com.example.yuan.mytest.Util.DateUtil;
import com.example.yuan.mytest.entity.BillInfo;
...
public class BillDBHelper extends DbHelper {
    ...
    public BillDBHelper(Context context) {
        ...
        mSelectSQL = String.format(
                "select rowid,_id,date,month,type,amount,desc,create_time,update_time from %s where"
                , mTableName);
    }
